// ==========================
// BlueKiosk - script.js
// (i18n, menu mobile, formulaire, EmailJS, Sheets)
// ==========================
...
const I18N = {
  fr: {
    ...
    "problem.h3": "Votre gourde peut être jusqu'à 40 000 fois plus sale qu'un siège de toilette",
    ...
    "solution.b1": "<strong>Désinfection Professionnelle :</strong> Technologie brevetée, fiable et performante, conçue en conformité avec l'ensemble des normes et certifications en vigueur",
    ...
    "form.intro": "Votre avis est crucial pour finaliser notre prototype. Répondez à ce petit questionnaire de 2 minutes et participez à l'aventure BlueKiosk.tech !",
  ...
  en: {
    ...
    "problem.h3": "Your bottle can be up to 40,000× dirtier than a toilet seat",
    ...
    "form.intro": "Your feedback is crucial to finalize our prototype. Answer this 2-minute survey and join the BlueKiosk.tech journey!",
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Menu mobile (toggle + accessibilité)
  ...
  form.querySelectorAll("select, input, textarea").forEach(el => {
    ...
    if (el.type === "radio") el.addEventListener("change", () => hideError(el.name));
  });
    ...
    try {
      ...
      if (emailOk.success) {
        if (successMessage) {
          ...
          alert(I18N[currentLang]["form.thanks"]);
        }
